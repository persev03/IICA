          ...
          {step === 1 ? (
            <form className="profile-form" onSubmit={startEvaluation}>
              ...
              <label className="check">
                <input type="checkbox" name="charger" /> Tengo posibilidad de instalar
                un cargador
              </label>
            ...
            <section className="profile-form result-pending">
              ...
              <p className="form-copy">
                IICA calculará un único resultado explicable para cada vehículo cuando
                el motor y los datos locales estén disponibles.
              </p>
